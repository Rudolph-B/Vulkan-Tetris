...
void
Engine::generateMipmaps(VkImage image, VkFormat imageFormat, int32_t texWidth, int32_t texHeight, uint32_t _mipLevels) {
...
VkImageView Engine::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags, uint32_t _mipLevels) {
...
void Engine::createImage(uint32_t width, uint32_t height, uint32_t _mipLevels, VkSampleCountFlagBits numSamples,
...
bool Engine::isDeviceSuitable(VkPhysicalDevice p_device) {
    QueueFamilyIndices qf_indices = findQueueFamilies(p_device);
